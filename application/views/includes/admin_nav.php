<header class="main-header">
    ...
    <a href="<?=base_url()?>home/dashboard" class="logo">
      ...
      <span class="logo-mini"><b>J</b>Kn</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>JunK</b>oin</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" >
        ...
        <li>
          <a href="<?= base_url() ?>/Home/viewUsers">
        ...
        <li>
          <a href="<?= base_url() ?>/Home/viewCompanies">
        ...
        <li>
          <a href="<?= base_url() ?>/Home/viewDiscounts">
